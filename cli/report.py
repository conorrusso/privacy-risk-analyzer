...
<div class="footer">
  <span>Generated by <a href="https://github.com/conorrusso/bandit">Bandit</a> v{APP_VERSION} &nbsp;·&nbsp; {_h(getattr(result, 'provider_model', '') or 'unknown')} &nbsp;·&nbsp; Rubric v{_h(result.version)}</span>
  <span>{_h(ts)}</span>
</div>
